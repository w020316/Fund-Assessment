...
class TestUploadHoldingsFile:
    ...
    def test_csv_upload_chinese_headers(self, client, auth_headers):
        ...
        csv_content = b"\xe5\x9f\xba\xe9\x87\x91\xe4\xbb\xa3\xe7\xa0\x81,\xe5\x9f\xba\xe9\x87\x91\xe5\x90\x8d\xe7\xa7\xb0,\xe6\x8c\x81\xe4\xbb\x93\xe6\xaf\x94\xe4\xbe\x8b\n161725,\xe6\x8b\x9b\xe5\x95\x86\xe7\x99\xbd\xe9\x85\x92,35.5%"
        resp = client.post(
            "/api/holdings/upload",
            files={"file": ("holdings.csv", csv_content, "text/csv")},
            headers=auth_headers,
